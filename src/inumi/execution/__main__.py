...
1. `uvicorn inumi.execution.api.app:app` (the Dockerfile/Makefile
...
Run `python -m inumi.execution` instead of the raw uvicorn CLI on Windows.
...
from inumi.common.config import get_settings  # noqa: E402

if __name__ == "__main__":
    settings = get_settings()
    uvicorn.run(
        "inumi.execution.api.app:app",
        host="0.0.0.0",
