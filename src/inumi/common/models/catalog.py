...
class LeastPrivilegeFinding(BaseModel):
    ...
    on user tables; Inumi never reads table contents" — but nothing ever
    ...
    introspection of the engine's own privilege views — Inumi reports, a
    ...
    def warning_text(self) -> str | None:
        ...
        return (
            ...
            f"— should be revoked for least-privilege; Inumi never needs to read table data."
        )
