...
from inumi.common.models.risk import RiskAssessment
from inumi.common.models.target import DatabaseTarget
from inumi.common.models.tool import ToolDefinition
from inumi.gateway.infrastructure.db.models import ApprovalEventRecord, ApprovalRecord
...
class ApprovalEngine:
    ...
    async def _get(self, approval_id: str) -> ApprovalRecord:
        ...
        if record is None:
            raise InumiError(FailureCode.APPROVAL_INVALID, "Approval not found.")
        return record
    ...
    async def decide(
        ...
        *,
        ...
        if record.status == ApprovalStatus.EXPIRED.value:
            raise InumiError(FailureCode.APPROVAL_EXPIRED, "This approval request has expired.")
