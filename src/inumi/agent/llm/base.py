...
_INTENT_SYSTEM = (
    ...
    "these, recognize them from ordinary phrasing:\n"
    "- \"servers\": list/show the registered servers "
    "(\"list my servers\", \"what servers do you have\", \"what's registered\")\n"
    "- \"playbooks\": list/show the known investigation playbooks "
    "(\"what playbooks do you have\", \"show me your playbooks\")\n"
    "- \"catalog\": show what was discovered on a server "
    "(\"what's on postgres-local\", \"show me the catalog for X\") — "
    "name the server as instance_hint too\n"
    ...
    "(\"what's the status\", \"where are we\", \"any update\")\n"
    "- \"approve\" / \"reject\": approve or reject a pending action "
    "(\"go ahead\", \"do it\", \"yes\", \"looks good\" -> approve; "
    "\"don't\", \"cancel that\", \"hold off\" -> reject) — only when "
    "the conversation actually has a pending approval to react to; "
    "never for an ordinary agreement unrelated to one\n"
